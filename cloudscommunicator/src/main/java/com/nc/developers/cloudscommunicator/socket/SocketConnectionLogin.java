...
public class SocketConnectionLogin{
    private static Socket socket;
    private static SSLContext sslContext;
    private static X509TrustManager x509TrustManager;
    private static TrustManager[] trustAllCerts;

    public static void makeLoginSocketConnection(String url){
        try {
            getX509TrustManager();
        ...
        try{
            ...
            socket.connect();
            SocketListenerLogin socketListenerLogin=new SocketListenerLogin();
            socketListenerLogin.listenLoginSocket(socket);
