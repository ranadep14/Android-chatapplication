...
public class SocketConnectionConv{
    private static Socket socket;
    private static SSLContext sslContext;
    private static X509TrustManager x509TrustManager;
    private static TrustManager[] trustAllCerts;

    public static void makeSocketConnection(String url){
        try {
            getX509TrustManager();
        ...
        try{
            ...
            socket.connect();
            SocketConnectionConvListener listener=new SocketConnectionConvListener();
            listener.listenConversationSocket(socket);
