    ...
    private void createEvent() {
        ...
        if (spin_persona.getSelectedItemPosition() == 0|| (edt_start_time.length() == 0)
            ...
            if (!check_date) {
                ...
                //Log.d("addeventselectecon",String.valueOf(selected_Conversation));

               selected_Conversation.createCalendarEventFromConversation(edit_group_nm.getText().toString(), personaSelected, selectedInvitee, jobCreateevent);
